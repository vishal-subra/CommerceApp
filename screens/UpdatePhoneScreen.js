...
const UpdatePhoneScreen = ({ route, navigation }) => {

	const { id } = route.params

	const onChangePhone = (text) => {

		navigation.setParams({ id: id, phone: text })
	...
	return (
		<View>
			<View style={styles.container}>
				<TextInput placeholder="Phone" style={styles.items} onChangeText={(text) => onChangePhone(text)} />
			</View>
